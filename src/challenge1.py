...
The computer chooses randomly between rock, paper, scissors
The user chooses between rock, paper, scissors
#he game ends when the computer or the user wins two rounds
"""
